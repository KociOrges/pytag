...
def annotate_abstract(address, abstract, ontotypes):
      """ A method to identify and annotate the ontological terms in the collected abstract. The abstract is processed using a custom named entity
      recognition (NER) system called EXTRACT. The system supports multiple ontologies and can recover the Genes/Proteins, PubChem Compounds, Environmental Ontology,
      NCBI Taxonomy, BRENDA Tissue Ontology, Disease Ontology, and Gene Ontology (biological process, cellular component, and molecular function)
      in a given piece of text. This information is given in the form of a TSV table.
      """
      ...
      # If the asbtract for the examined reference is not available in the BibTex file, then follow the associated address in PubMed database to collect the text #
      if not abstract:
            try:
                  ...
                  # If everything is fine with the link then read the records for the examined reference and assign them in a string variable #
                  ...
                  if(text_start != -1 and text_end != -1):
                        ...
                        # The tagger has a limit in the length of the text it can process. If more than 6000 characters the text is truncated. #
