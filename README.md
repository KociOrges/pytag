...
```
Here, we have put the generated BibTex files for each keyword search inside the folder BibTex files/. <span style="color:blue">*This is Blue italic.* text</span>
